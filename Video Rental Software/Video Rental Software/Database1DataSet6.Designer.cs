...
namespace Video_Rental_Software {
    ...
    public partial class Database1DataSet6 : global::System.Data.DataSet {
        ...
        public partial class borrowDataTable : global::System.Data.TypedTableBase<borrowRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public borrowRow AddborrowRow(int Id, string name, string add, string cat) {
        ...
        public partial class borrowRow : global::System.Data.DataRow {
            ...
            public string add {
                get {
                    try {
                        return ((string)(this[this.tableborrow.addColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'add\' in table \'borrow\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableborrow.addColumn] = value;
                }
            }
            ...
            public string cat {
                get {
                    try {
                        return ((string)(this[this.tableborrow.catColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'cat\' in table \'borrow\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableborrow.catColumn] = value;
                }
            }
            ...
            public bool IsaddNull() {
                return this.IsNull(this.tableborrow.addColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetaddNull() {
                this[this.tableborrow.addColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public bool IscatNull() {
                return this.IsNull(this.tableborrow.catColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetcatNull() {
                this[this.tableborrow.catColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Video_Rental_Software.Database1DataSet6TableAdapters {
    ...
    public partial class borrowTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[borrow] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_add = 1 AND [add] IS NULL) OR ([add] = @Original_add)) AND ((@IsNull_cat = 1 AND [cat] IS NULL) OR ([cat] = @Original_cat)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[borrow] ([Id], [name], [add], [cat]) VALUES (@Id, @name, @add," +
                " @cat);\r\nSELECT Id, name, [add], cat FROM borrow WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[borrow] SET [Id] = @Id, [name] = @name, [add] = @add, [cat] = @cat WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_add = 1 AND [add] IS NULL) OR ([add] = @Original_add)) AND ((@IsNull_cat = 1 AND [cat] IS NULL) OR ([cat] = @Original_cat)));
SELECT Id, name, [add], cat FROM borrow WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, [add], cat FROM dbo.borrow";
        ...
        public virtual int Fill(Database1DataSet6.borrowDataTable dataTable) {
        ...
        public virtual Database1DataSet6.borrowDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet6.borrowDataTable dataTable = new Database1DataSet6.borrowDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet6.borrowDataTable dataTable) {
        ...
        public virtual int Update(int Id, string name, string add, string cat, int Original_Id, string Original_name, string Original_add, string Original_cat) {
            ...
            if ((Original_add == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_add));
            }
            if ((Original_cat == null)) {
