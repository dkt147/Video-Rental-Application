...
namespace Video_Rental_Software {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class moviesDataTable : global::System.Data.TypedTableBase<moviesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public moviesRow AddmoviesRow(int Id, string name, string code, int price) {
        ...
        public partial class moviesRow : global::System.Data.DataRow {
            ...
            public string code {
                get {
                    try {
                        return ((string)(this[this.tablemovies.codeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'code\' in table \'movies\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablemovies.codeColumn] = value;
                }
            }
            ...
            public bool IscodeNull() {
                return this.IsNull(this.tablemovies.codeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetcodeNull() {
                this[this.tablemovies.codeColumn] = global::System.Convert.DBNull;
            }
...
namespace Video_Rental_Software.Database1DataSet4TableAdapters {
    ...
    public partial class moviesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[movies] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[movies] ([Id], [name], [code], [price]) VALUES (@Id, @name, @c" +
                "ode, @price);\r\nSELECT Id, name, code, price FROM movies WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[movies] SET [Id] = @Id, [name] = @name, [code] = @code, [price] = @price WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT Id, name, code, price FROM movies WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, code, price FROM dbo.movies";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_code, global::System.Nullable<int> Original_price) {
        ...
        public virtual int Insert(int Id, string name, string code, global::System.Nullable<int> price) {
        ...
        public virtual int Update(int Id, string name, string code, global::System.Nullable<int> price, int Original_Id, string Original_name, string Original_code, global::System.Nullable<int> Original_price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string code, global::System.Nullable<int> price, int Original_Id, string Original_name, string Original_code, global::System.Nullable<int> Original_price) {
            return this.Update(Original_Id, name, code, price, Original_Id, Original_name, Original_code, Original_price);
        }
    }
